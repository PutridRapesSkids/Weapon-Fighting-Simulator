...
game.StarterGui:SetCore("SendNotification", {
   ...
   Text = 'the script will still work but our server link was copied to your clipboard ';
   Duration = 10;
  })
  setclipboard('https://discord.gg/K2F52c5NcA')
...
miscSec:addButton("Created by git#0001", function() 
print("ASD")
end)

miscSec:addKeybind("Keybind", Enum.KeyCode.V, function()
venyx:toggle()
end)
